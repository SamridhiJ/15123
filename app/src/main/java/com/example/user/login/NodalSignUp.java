...
public  class NodalSignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nodal_sign_up);
    ...
    public void nodalsubmit(View v)
    {s5=e5.getText().toString();
      DatabaseReference rf=db.getReference("NodalOfficer/"+s5);
